...
public static class AuthConfiguration
{
    public static IServiceCollection AddAppAuth(this IServiceCollection services, IdentitySettings settings)
    {
        ...
        {
            options.AddPolicy(AppScopes.CollectionsRead, policy => policy.RequireClaim("scope", AppScopes.CollectionsRead));
            options.AddPolicy(AppScopes.CollectionsWrite, policy => policy.RequireClaim("scope", AppScopes.CollectionsWrite));
        });
